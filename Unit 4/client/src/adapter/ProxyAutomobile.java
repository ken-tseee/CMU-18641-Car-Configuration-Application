...
public abstract class ProxyAutomobile {
	...
	public void buildAuto(String filename, String fileType) throws IOException {
		if(fileType.equals("txt")) {
			...
			CarModelOptionsIO fio = new CarModelOptionsIO();
			fio.buildProperties(filename);
		}
	}
	/**
	...
	public void printAuto(String Modelname) {
		try {
			Iterator<Entry<String, Automobile>> lit = autoLHM.entrySet().iterator();
			while(lit.hasNext()) {
